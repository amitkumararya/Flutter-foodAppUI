...
class Burgerpage extends StatefulWidget {
  ...
  @override
  _BrgerpageState createState() => _BrgerpageState();
}

class _BrgerpageState extends State<Burgerpage> {
  var netPrice = 0.0;
  var quantity = 1;
  ...
  _buildListItem(String columnNumber) {
    return Padding(
        ...
        child: Column(
          children: <Widget>[
            if(columnNumber == '1')
              _buildColumnItem('assets/pizza.png', BoxFit.cover,'cheese', '30', Color(0xFFFBD6F5)),
            if(columnNumber == '1')
              SizedBox(height: 15.0),
            if(columnNumber == '1')
              _buildColumnItem('assets/popcorn.png', BoxFit.cover,' popcorn', '20', Color(0xFFFBD6F5)),
            if(columnNumber == '2')
              _buildColumnItem('assets/toast.png',BoxFit.cover, 'tost', '30',
                  Color(0xFFC2E3FE)),
            if(columnNumber == '2')
              SizedBox(height: 15.0),
            if(columnNumber == '2')
              _buildColumnItem('assets/Sandwich.png',BoxFit.cover, 'Sandwich', '49',
                  Color(0xFFD7FADA)),
          ],
        )
    );
  ...
  _buildColumnItem(String imgPath,BoxFit, String foodName, String price, Color bgColor) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: <Widget>[
        Container(
